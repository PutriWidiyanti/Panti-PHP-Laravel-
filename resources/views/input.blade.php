...
<head>
    ...
    <title>Form Pendaftaran Penghuni Panti</title>
        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form action="/Diri/store" method="post" class="register-form">
                        {{ csrf_field() }}
                        <h2>Form Pendaftaran Penghuni Panti</h2>
                        <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_orangtua" required="required" />
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="pendidikan" required="required" />
                            </div>
                            <div class="form-group">
