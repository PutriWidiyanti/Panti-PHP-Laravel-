...
<head>
    ...
    <title>Form Pendaftaran Donatur Tetap</title>
        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form action="/Diri/inDonatur" method="post" class="register-form">
                        {{ csrf_field() }}
                        <h2>Form Pendaftaran Donatur Tetap</h2>
                        <div class="form-row">
                            <div class="form-group">
                                <label for="id_donatur">Id Donatur :</label>
                                <input type="text" name="id_donatur" required="required" />
                            </div>
                            <div class="form-group">
